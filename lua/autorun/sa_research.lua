...
SA_AddResearch("ore_laser_yield[2]", "Asteroid Mining", "Augmented Mining Lasers II", 300, 800000, 0.625, "Each rank increases the amount of ore mined by the MkII laser by 12.5 a second.", "unlock", {{"ore_laser_yield[1]", 300}, {"ore_laser_level", 1}}, 2, {"sa_mining_laser_ii"}, "laser_icon_ii.png")
SA_AddResearch("ore_laser_yield[3]", "Asteroid Mining", "Augmented Mining Lasers III", 300, 2500000, 0.4, "Each rank increases the amount of ore mined by the MkIII laser by 25 a second.", "unlock", {{"ore_laser_yield[2]", 300}, {"ore_laser_level", 2}}, 3, {"sa_mining_laser_iii"}, "laser_icon_iii.png")
SA_AddResearch("ore_laser_yield[4]", "Asteroid Mining", "Augmented Mining Lasers IV", 300, 6250000, 0.32, "Each rank increases the amount of ore mined by the MkIV laser by 50 a second.", "unlock", {{"ore_laser_yield[3]", 300}, {"ore_laser_level", 3}}, 4, {"sa_mining_laser_iv"}, "laser_icon_iv.png")
SA_AddResearch("ore_laser_yield[5]", "Asteroid Mining", "Augmented Mining Lasers V", 300, 12500000, 0.32, "Each rank increases the amount of ore mined by the MkV laser by 100 a second.", "unlock", {{"ore_laser_yield[4]", 300}, {"ore_laser_level", 4}}, 5, {"sa_mining_laser_v"}, "laser_icon_v.png")
SA_AddResearch("ore_laser_yield[6]", "Asteroid Mining", "Augmented Mining Lasers VI", 300, 25000000, 0.32, "Each rank increases the amount of ore mined by the MkVI laser by 200 a second.", "unlock", {{"ore_laser_yield[5]", 300}, {"ore_laser_level", 5}, {"faction", {"miners", "alliance"}}}, 6, {"sa_mining_laser_vi"}, "laser_icon_vi.png")
...
SA_AddResearch("tiberium_drill_yield[1]", "Tiberium Mining", "Augmented Mining Drill", 300, 12000, 25, "Each rank increases the amount of tiberium mined by the drill by 10 a second.", "none", {}, 1, {"sa_mining_drill"}, "tiberium_drill_icon_i.png")
SA_AddResearch("tiberium_drill_yield[2]", "Tiberium Mining", "Augmented Mining Drill II", 300, 24000, 25, "Each rank increases the amount of tiberium mined by the drill II by 20 a second.", "unlock", {{"tiberium_drill_yield[1]", 300}, {"tiberium_drill_level", 1}, {"faction", {"legion", "alliance"}}}, 2, {"sa_mining_drill_ii"}, "tiberium_drill_icon_ii.png")
