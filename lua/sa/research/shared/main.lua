...
SA_AddResearch("ore_laser_yield[6]", "Asteroid Mining", "Augmented Mining Lasers VI", 300, 25000000, 0.0032, "Each rank increases the amount of ore mined by the MkVI laser by 400 a second.", "unlock", {{"ore_laser_yield[5]", 300}, {"ore_laser_level", 5}, {"faction", {"miners", "alliance"}}}, 6, {"sa_mining_laser"}, "laser_icon_vi.png")
SA_AddResearch("ore_laser_level", "Asteroid Mining", "Mining Theory", 5, 5000000, 1, "Unlocks the use of more powerful Mining Lasers.", "perrank", {{{"ore_laser_yield[1]", 300}}, {{"ore_laser_yield[2]", 300}}, {{"ore_laser_yield[3]", 300}}, {{"ore_laser_yield[4]", 300}}, {{"ore_laser_yield[5]", 300}, {"faction", {"miners", "alliance"}}}}, 7, {}, "laser_icon_research.png")
...
SA_AddResearch("ore_storage_capacity[1]", "Asteroid Mining", "Increased Ore Capacity - Small", 300, 5000, 0.25, "Each rank increases the capacity of the small ore storage container by 5000.", "none", {}, 9, {"ore_storage"}, "laser_storage_icon_small.png")
...
SA_AddResearch("ore_storage_capacity[5]", "Asteroid Mining", "Increased Ore Capacity - Giant", 300, 5000000, 0.0032, "Each rank increases the capacity of the giant ore storage container by 80000.", "unlock", {{"ore_storage_capacity[4]", 300}, {"ore_storage_level", 4}, {"faction", {"miners", "starfleet", "alliance"}}}, 13, {"sa_storage_ore"}, "laser_storage_icon_giant.png")
SA_AddResearch("ore_storage_level", "Asteroid Mining", "Ore Management", 4, 2500000, 1, "Unlocks the use of bigger ore containers.", "perrank", {{{"ore_storage_capacity[1]", 300}}, {{"ore_storage_capacity[2]", 300}}, {{"ore_storage_capacity[3]", 300}}, {{"ore_storage_capacity[4]", 300}, {"faction", {"miners", "starfleet", "alliance"}}}}, 14, {}, "storage_icon_research.png")
...
SA_AddResearch("tiberium_drill_yield[2]", "Tiberium Mining", "Augmented Mining Drill II", 300, 24000, 0.25, "Each rank increases the amount of tiberium mined by the drill II by 40 a second.", "unlock", {{"tiberium_drill_yield[1]", 300}, {"tiberium_drill_level", 1}, {"faction", {"legion", "alliance"}}}, 2, {"sa_mining_drill"}, "tiberium_drill_icon_ii.png")
SA_AddResearch("tiberium_drill_level", "Tiberium Mining", "Tiberium Drills", 1, 25000000, 1, "Unlocks the use of better tiberium drills.", "perrank", {{{"tiberium_drill_yield[1]", 300}, {"faction", {"legion", "alliance"}}}}, 3, {}, "tiberium_drill_icon_research.png")
...
SA_AddResearch("ice_refinery_level", "Ice Mining", "Ice Refineries", 2, 750000000, 1.5, "Allows using better ice refineries.", "none", {}, 1, {}, "ice_icon_refinery_research.png")
SA_AddResearch("ice_laser_level", "Ice Mining", "Ice Lasers", 2, 1000000000, 1.5, "Allows using better ice lasers.", "none", {}, 2, {}, "ice_icon_research.png")
SA_AddResearch("ice_raw_storage_level", "Ice Mining", "Ice Storages", 4, 300000000, 1.5, "Allows using better raw Ice Storages.", "none", {}, 3, {}, "storage_icon_research.png")
SA_AddResearch("ice_product_storage_level", "Ice Mining", "Ice Product Storages", 6, 300000000, 1.5, "Allows using better ice product storages.", "none", {}, 4, {}, "storage_icon_research.png")
