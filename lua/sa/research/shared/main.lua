...
SA_AddResearch("ore_storage_capacity[5]", "Asteroid Mining", "Increased Ore Capacity - Giant", 300, 5000000, 0.0032, "Each rank increases the capacity of the giant ore storage container by 80000.", "unlock", {{"ore_storage_capacity[4]", 300}, {"ore_storage_level", 4}, {"faction", {"miners", "alliance"}}}, 13, {"sa_storage_ore"}, "laser_storage_icon_giant.png")
SA_AddResearch("ore_storage_level", "Asteroid Mining", "Ore Management", 4, 2500000, 1, "Unlocks the use of bigger ore containers.", "perrank", {{{"ore_storage_capacity[1]", 300}}, {{"ore_storage_capacity[2]", 300}}, {{"ore_storage_capacity[3]", 300}}, {{"ore_storage_capacity[4]", 300}, {"faction", {"miners", "alliance"}}}}, 14, {}, "storage_icon_research.png")
