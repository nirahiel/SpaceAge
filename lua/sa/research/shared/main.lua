...
SA_AddResearch("ore_laser_yield[2]", "Asteroid Mining", "Augmented Mining Lasers II", 300, 800000, 0.625, "Each rank increases the amount of ore mined by the MkII laser by 25 a second.", "unlock", {{"ore_laser_yield[1]", 300}, {"ore_laser_level", 1}}, 2, {"sa_mining_laser"}, "laser_icon_ii.png")
SA_AddResearch("ore_laser_yield[3]", "Asteroid Mining", "Augmented Mining Lasers III", 300, 2500000, 0.4, "Each rank increases the amount of ore mined by the MkIII laser by 50 a second.", "unlock", {{"ore_laser_yield[2]", 300}, {"ore_laser_level", 2}}, 3, {"sa_mining_laser"}, "laser_icon_iii.png")
SA_AddResearch("ore_laser_yield[4]", "Asteroid Mining", "Augmented Mining Lasers IV", 300, 6250000, 0.32, "Each rank increases the amount of ore mined by the MkIV laser by 100 a second.", "unlock", {{"ore_laser_yield[3]", 300}, {"ore_laser_level", 3}}, 4, {"sa_mining_laser"}, "laser_icon_iv.png")
SA_AddResearch("ore_laser_yield[5]", "Asteroid Mining", "Augmented Mining Lasers V", 300, 12500000, 0.32, "Each rank increases the amount of ore mined by the MkV laser by 200 a second.", "unlock", {{"ore_laser_yield[4]", 300}, {"ore_laser_level", 4}}, 5, {"sa_mining_laser"}, "laser_icon_v.png")
SA_AddResearch("ore_laser_yield[6]", "Asteroid Mining", "Augmented Mining Lasers VI", 300, 25000000, 0.32, "Each rank increases the amount of ore mined by the MkVI laser by 400 a second.", "unlock", {{"ore_laser_yield[5]", 300}, {"ore_laser_level", 5}, {"faction", {"miners", "alliance"}}}, 6, {"sa_mining_laser"}, "laser_icon_vi.png")
...
SA_AddResearch("ore_storage_capacity[2]", "Asteroid Mining", "Increased Ore Capacity - Medium", 300, 400000, 0.625, "Each rank increases the capacity of the medium ore storage container by 10000.", "unlock", {{"ore_storage_capacity[1]", 300}, {"ore_storage_level", 1}}, 10, {"sa_storage_ore"}, "laser_storage_icon_med.png")
SA_AddResearch("ore_storage_capacity[3]", "Asteroid Mining", "Increased Ore Capacity - Large", 300, 1250000, 0.4, "Each rank increases the capacity of the large ore storage container by 20000.", "unlock", {{"ore_storage_capacity[2]", 300}, {"ore_storage_level", 2}}, 11, {"sa_storage_ore"}, "laser_storage_icon_large.png")
SA_AddResearch("ore_storage_capacity[4]", "Asteroid Mining", "Increased Ore Capacity - Huge", 300, 2500000, 0.32, "Each rank increases the capacity of the huge ore storage container by 40000.", "unlock", {{"ore_storage_capacity[3]", 300}, {"ore_storage_level", 3}}, 12, {"sa_storage_ore"}, "laser_storage_icon_huge.png")
SA_AddResearch("ore_storage_capacity[5]", "Asteroid Mining", "Increased Ore Capacity - Giant", 300, 5000000, 0.32, "Each rank increases the capacity of the giant ore storage container by 80000.", "unlock", {{"ore_storage_capacity[4]", 300}, {"ore_storage_level", 4}, {"faction", {"miners", "starfleet", "alliance"}}}, 13, {"sa_storage_ore"}, "laser_storage_icon_giant.png")
...
SA_AddResearch("tiberium_drill_yield[2]", "Tiberium Mining", "Augmented Mining Drill II", 300, 24000, 25, "Each rank increases the amount of tiberium mined by the drill II by 40 a second.", "unlock", {{"tiberium_drill_yield[1]", 300}, {"tiberium_drill_level", 1}, {"faction", {"legion", "alliance"}}}, 2, {"sa_mining_drill"}, "tiberium_drill_icon_ii.png")
...
SA_AddResearch("tiberium_storage_capacity[1]", "Tiberium Mining", "Increased Tiberium Capacity", 300, 5000, 16, "Each rank increases the capacity of the tiberium storage container by 5000.", "none", {}, 4, {"sa_storage_tiberium"}, "tiberium_storage_icon_i.png")
SA_AddResearch("tiberium_storage_capacity[2]", "Tiberium Mining", "Increased Tiberium Capacity II", 300, 10000, 16, "Each rank increases the capacity of the tiberium storage container II by 10000.", "unlock", {{"tiberium_drill_yield[1]", 300}, {"tiberium_storage_level", 1}, {"faction", {"legion", "alliance"}}}, 5, {"sa_storage_tiberium"}, "tiberium_storage_icon_ii.png")
