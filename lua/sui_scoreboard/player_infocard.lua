...
function PANEL:UpdatePlayerData()
	...
	self:SetInfo( 1, "Props:", (self.Player:GetCount( "props" ) or 0 ))
	self:SetInfo( 1, "HoverBalls:", (self.Player:GetCount( "hoverballs" ) or 0 ))
	self:SetInfo( 1, "Thrusters:", (self.Player:GetCount( "thrusters" ) or 0 ))
	self:SetInfo( 1, "Balloons:", (self.Player:GetCount( "balloons" ) or 0))
	self:SetInfo( 1, "Buttons:", (self.Player:GetCount( "buttons" ) or 0))
	self:SetInfo( 1, "Dynamite:", (self.Player:GetCount( "dynamite" ) or 0))
	self:SetInfo( 1, "SENTs:", (self.Player:GetCount( "sents" ) or 0))

	self:SetInfo( 2, "Ragdolls:", (self.Player:GetCount( "ragdolls" ) or 0))
	self:SetInfo( 2, "Effects:", (self.Player:GetCount( "effects" ) or 0))
	self:SetInfo( 2, "Vehicles:", (self.Player:GetCount( "vehicles" ) or 0))
	self:SetInfo( 2, "Npcs:", (self.Player:GetCount( "npcs" ) or 0))
	self:SetInfo( 2, "Emitters:", (self.Player:GetCount( "emitters" ) or 0))
	self:SetInfo( 2, "Lamps:", (self.Player:GetCount( "lamps" ) or 0))
	self:SetInfo( 2, "Spawners:", (self.Player:GetCount( "spawners" ) or 0))
