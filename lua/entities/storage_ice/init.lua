...
function ENT:CalcVars(ply)
	...
	if ((reqLvl == nil) or (ply.SAData.Research.IceRawStorageLevel < reqLvl)) then self:Remove() return end

	local Capacity = math.floor(8 * (4.5 ^ reqLvl)) * ply.SAData.Research.GlobalMultiplier
