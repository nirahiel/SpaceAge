...
function ENT:Initialize()
	...
	if not ply:IsAdmin() then self:SetModel("models/Slyfo/nacshortsleft.mdl") end
...
function ENT:CalcVars(ply)
	if not (ply.oremanage > 0) then self:Remove() return end
	self.IsOreStorage = true
	RD.AddResource(self, "ore", (1600000 + ply.oremod_ii * 10000) * ply.devlimit, 0)
end
